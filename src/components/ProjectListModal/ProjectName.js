              ...
              <div className={styles.listWrapper}>
                <ul className={styles.listContent}>
                  ...
                  <li>
                    ...
                    <span className={styles.rightStyle}>
                      {projectModalDataInfo.basic_info ? projectModalDataInfo.basic_info.product_manager_name : ''}
                    </span>
                  </li>
                  <li>
                    <span className={styles.leftStyle}>运维：</span>
                    <span className={styles.rightStyle}>
                      {projectModalDataInfo.basic_info ? projectModalDataInfo.basic_info.ops_user_name : ''}
                    </span>
                  </li>
                  <li>
                    <span className={styles.leftStyle}>测试人员：</span>
                    <span className={styles.rightStyle}>
                      {projectModalDataInfo.basic_info ? projectModalDataInfo.basic_info.test_user_name : ''}
                    </span>
                  </li>
                </ul>
              </div>
              <div className={styles.rightWrapper}>
                <ul className={styles.listContent}>
                  ...
                  <li>
                    ...
                    <span className={styles.rightStyle}>
                      {projectModalDataInfo.basic_info ? projectModalDataInfo.basic_info.develop_user_name : ''}
                    </span>
                  </li>
                  <li>
                    <span className={styles.leftStyle}>其他人员：</span>
                    <span className={styles.rightStyle}>
                      {projectModalDataInfo.basic_info ? projectModalDataInfo.basic_info.other_user_name : ''}
                    </span>
                  </li>
                  <li>
