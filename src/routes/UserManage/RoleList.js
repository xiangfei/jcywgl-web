      ...
      render: (text, record) => {
        return (
          <Spin spinning={this.props.operatorLoading}>
            <a className={styles.optBtn} onClick={this.editRole.bind(this, record)}>编辑</a>
            <a className={styles.optBtn} onClick={this.authorRole.bind(this, record)}>授权</a>
            <a className={styles.optBtn} onClick={this.manageRole.bind(this, record)}>管理</a>
            <a className={styles.optBtn} onClick={this.deleteRole.bind(this, record)}>删除</a>
          </Spin>
        );
      },
    }];
